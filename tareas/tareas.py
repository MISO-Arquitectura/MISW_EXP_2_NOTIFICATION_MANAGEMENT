...
def enviar_alerta(datos_log):
    ...
    receiver_email_address = "saidnaderm@gmail.com"
    ...
    # Set email body text
    message.set_content(
        f'Se ha detectado una solicitud inusual desde la ip: {datos_log["request"]["req"]["ip_address"]} por favor revisa si fuiste tu')
